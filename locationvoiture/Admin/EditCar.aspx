<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCar.aspx.cs" Inherits="locationvoiture.Admin.EditCar" %>
...
<head>
    ...
    <style>
        ...
        .editcar-container { max-width: 520px; margin: 60px auto; background: #fff; border-radius: 18px; box-shadow: 0 6px 28px #e1eaf5b2; padding: 38px 32px 30px 32px;}
        .form-title { font-size: 1.34em; font-weight: 800; color: #185adb; text-align: center; margin-bottom: 26px; }
...
<body>
    <form id="form1" runat="server">
        <div class="editcar-container">
            <div class="form-title">Edit Car (Admin)</div>
